...
import dbConfigRoutes from './routes/db-config.js';

// Adapter Integrato (Node.js)
...
import itemImagesRoutes from './routes/item-images.js';
...
app.use(`${API_PREFIX}/db-config`, dbConfigRoutes);

// ============================================
// AI ASSISTANT
// ============================================

app.use(`${API_PREFIX}/ai`, aiAssistantRoutes);
app.use(`${API_PREFIX}/ai-config`, aiConfigRoutes);
app.use(`${API_PREFIX}/integrations`, integrationsRoutes);
app.use(`${API_PREFIX}/item-images`, itemImagesRoutes);
console.log('[AI ASSISTANT] AI routes mounted at /api/ai/*');
console.log('[AI CONFIG] AI configuration routes mounted at /api/ai-config/*');
console.log('[INTEGRATIONS] Integrations routes mounted at /api/integrations/*');

// ============================================
// ADAPTER INTEGRATO (sostituisce adapter .NET)
// ============================================

app.use(`${API_PREFIX}/adapter`, adapterRoutes);
console.log('[ADAPTER] Adapter integrato montato su /api/adapter/*');
