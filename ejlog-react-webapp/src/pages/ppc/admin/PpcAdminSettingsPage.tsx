...
import SettingsPageAdvanced from '../../config/SettingsPage';
...
const PpcAdminSettingsPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600">
            PPC admin workspace for advanced configuration.
          </p>
        </div>
      ...
      <Card title="Advanced Settings" variant="outlined">
...
export default PpcAdminSettingsPage;
