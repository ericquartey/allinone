...
const PpcBay1DeviceIOPage: React.FC = () => {
  ...
  return (
    <div className="ppc-page">
      <div className="ppc-grid">
        <PpcSensorsNavMenu activeKey="io1" />

        <div className="ppc-center-grid">
          <h1 className="ppc-title">{ppcT('InstallationApp.Bay1', 'Bay 1')}</h1>
          ...
          <div className="ppc-sensor-list ppc-currents">
            {currentEntries.map((entry, index) => (
              <div key={entry.id} className="ppc-value-row">
                ...
                <span className="ppc-value">{currents[index] ?? 0}</span>
              </div>
            ))}
          </div>
        </div>
...
export default PpcBay1DeviceIOPage;
