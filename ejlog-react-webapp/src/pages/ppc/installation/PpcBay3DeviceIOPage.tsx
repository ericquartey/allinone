...
const PpcBay3DeviceIOPage: React.FC = () => {
  ...
  const faultOffset = 16;
  const currentOffset = 32;

  return (
    <div className="ppc-page">
      <div className="ppc-grid">
        <PpcSensorsNavMenu activeKey="io3" />

        <div className="ppc-center-grid">
          <h1 className="ppc-title">{ppcT('InstallationApp.Bay3', 'Bay 3')}</h1>
...
export default PpcBay3DeviceIOPage;
