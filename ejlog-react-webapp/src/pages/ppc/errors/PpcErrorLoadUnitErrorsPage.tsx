...
const PpcErrorLoadUnitErrorsPage: React.FC = () => {
  ...
  const additionalText =
    machineError?.AdditionalText || ppcT('OperatorApp.AdditionalText', 'Additional text');
      ...
      <div className="ppc-error-wizard__layout">
        ...
        <div className="ppc-error-wizard__side">
          <PpcSensorCard
            ...
            lines={[ppcT('SensorCard.Position', 'Position'), 'X 120 / Y 42']}
          />
          <PpcSensorCard
          ...
          <PpcSensorCard
            ...
            lines={[ppcT('SensorCard.Closed', 'Closed')]}
          />
        </div>
      </div>
    </div>
...
export default PpcErrorLoadUnitErrorsPage;
