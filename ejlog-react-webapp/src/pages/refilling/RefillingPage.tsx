// ============================================================================
// EJLOG WMS - Refilling Operations Page
// Gestione operazioni di rifornimento (refilling)
// ============================================================================
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center space-x-3">
          <TrendingUp className="w-8 h-8 text-ferretto-red" />
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Esecuzione Refilling</h1>
            <p className="text-sm text-gray-600 mt-1">
              Gestione operazioni di rifornimento ubicazioni
            </p>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Visualizza liste refilling attive
              </p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Gestione completa liste refilling
              </p>
            </div>
            <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-ferretto-red" />
          </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <strong>Info:</strong> Per eseguire il refilling di una lista specifica, naviga a{' '}
