...
import { useGetOperationQuery, useCompleteOperationMutation } from '../../services/api/operationsApi';
...
const ExecuteOperationPage: React.FC = () => {
  ...
  const { data: operation, isLoading } = useGetOperationQuery(Number(id));
  const [completeOperation, { isLoading: isCompleting }] = useCompleteOperationMutation();
