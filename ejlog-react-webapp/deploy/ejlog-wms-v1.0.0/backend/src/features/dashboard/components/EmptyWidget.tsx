// ============================================================================
// EJLOG WMS - Empty Widget State
// Componente per visualizzare stato vuoto nei widget
// ============================================================================
...
/**
 * Componente per stato vuoto widget
 */
export const EmptyWidget: React.FC<EmptyWidgetProps> = ({
  ...
  const renderIcon = () => {
    const iconClass = 'w-16 h-16 text-gray-400 mb-4';
